        ...
        <div class="confirm-table">
            <table class="confirm-table__inner">
                <tr class="confirm-table__row">
                    ...
                    <td class="confirm-table__text">{{ $contact['last_name'] }}&emsp;{{ $contact['first_name'] }}</td>
                </tr>
                <tr class="confirm-table__row">
                    <th class="confirm-table__header">性別</th>
                    <td class="confirm-table__text">{{ $contact['gender_text']}}</td>
                </tr>
                <tr class="confirm-table__row">
                ...
                <tr class="confirm-table__row">
                    ...
                    <td class="confirm-table__text">{!! nl2br(e($contact['detail'])) !!}</td>
                </tr>
            </table>
        </div>

        <div class="form__button">
            <button class="btn__dark form__button-submit" type="submit">送信</button>
